...
export function getTikTokData(period: TimePeriod): TikTokData {
  return {
    ...
    videoPerformance: [
      { id: "v1", title: "Morgenroutine schiefgelaufen", thumbnailUrl: "https://picsum.photos/seed/ttv1/400/300", views: 12_400_000, likes: 980_000, shares: 145_000, comments: 89_000, saves: 210_000, avgWatchTime: "18.2s", watchFullPercentage: 42, postedAt: "2026-02-10" },
      { id: "v2", title: "POV: Erster Tag im neuen Job", thumbnailUrl: "https://picsum.photos/seed/ttv2/400/300", views: 8_900_000, likes: 720_000, shares: 98_000, comments: 67_000, saves: 156_000, avgWatchTime: "15.8s", watchFullPercentage: 38, postedAt: "2026-02-08" },
      { id: "v3", title: "Ich teste jedes Street Food in Tokyo", thumbnailUrl: "https://picsum.photos/seed/ttv3/400/300", views: 6_200_000, likes: 540_000, shares: 78_000, comments: 45_000, saves: 189_000, avgWatchTime: "22.1s", watchFullPercentage: 28, postedAt: "2026-02-05" },
      { id: "v4", title: "3-Minuten-Rezepte die du brauchst", thumbnailUrl: "https://picsum.photos/seed/ttv4/400/300", views: 5_800_000, likes: 490_000, shares: 67_000, comments: 38_000, saves: 320_000, avgWatchTime: "14.5s", watchFullPercentage: 45, postedAt: "2026-02-03" },
      { id: "v5", title: "So habe ich 10.000€ diesen Monat verdient", thumbnailUrl: "https://picsum.photos/seed/ttv5/400/300", views: 4_100_000, likes: 380_000, shares: 56_000, comments: 34_000, saves: 98_000, avgWatchTime: "16.7s", watchFullPercentage: 31, postedAt: "2026-01-30" },
      { id: "v6", title: "Outfit-Check Challenge", thumbnailUrl: "https://picsum.photos/seed/ttv6/400/300", views: 3_700_000, likes: 310_000, shares: 42_000, comments: 28_000, saves: 76_000, avgWatchTime: "11.3s", watchFullPercentage: 52, postedAt: "2026-01-28" },
      { id: "v7", title: "Life Hack: Ordnungstipps", thumbnailUrl: "https://picsum.photos/seed/ttv7/400/300", views: 2_900_000, likes: 260_000, shares: 38_000, comments: 22_000, saves: 145_000, avgWatchTime: "19.8s", watchFullPercentage: 26, postedAt: "2026-01-25" },
      { id: "v8", title: "Duett mit @creator123", thumbnailUrl: "https://picsum.photos/seed/ttv8/400/300", views: 2_100_000, likes: 190_000, shares: 29_000, comments: 18_000, saves: 34_000, avgWatchTime: "9.6s", watchFullPercentage: 58, postedAt: "2026-01-22" },
    ],
    trendingHashtags: [
